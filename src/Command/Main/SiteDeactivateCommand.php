...
class SiteDeactivateCommand extends Command
{
    /** @var string */
    public const COMMAND_NAME = 'site:deactivate';
    ...
    protected function configure()
    {
        ...
        $this->setDescription('Deactivate site');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $result = SiteTable::update($site['LID'], ['ACTIVE' => 'N']);
            if (!$result->isSuccess()) {
                throw new \Exception(sprintf('Failed deactivate "%s" site', $id));
            }
